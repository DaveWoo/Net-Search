...
namespace Net.HostServer.Controllers
{
	public class ADController : Controller
	{
		...
		public ActionResult Edit(int id, [Bind(Include = "Id,Url,Title,Content,Tag")] Net.Models.SiteAD ad)
		{
			try
			{
				// TODO: Add update logic here
				bool isSucceed = client.UpdateSiteAD(ad.Url, ad.Title, ad.Content, "AD", ad.Tag);
				return RedirectToAction("Index");
			}
			catch
			{
